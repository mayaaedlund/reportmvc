...
return [
    ...
    [ // $dynamicRoutes
        35 => [[['_route' => 'test_roll_num_dices', '_controller' => 'App\\Controller\\DiceGameController::testRollDices'], ['num'], null, null, false, true, null]],
        56 => [[['_route' => 'test_dicehand', '_controller' => 'App\\Controller\\DiceGameController::testDiceHand'], ['num'], null, null, false, true, null]],
        85 => [[['_route' => 'draw_multiple', '_controller' => 'App\\Controller\\DrawCardController::draw_multiple'], ['num'], null, null, false, true, null]],
        117 => [[['_route' => 'book_by_id', '_controller' => 'App\\Controller\\LibraryController::showBookById'], ['id'], null, null, false, true, null]],
        143 => [[['_route' => 'book_change', '_controller' => 'App\\Controller\\LibraryController::changeBook'], ['id'], null, null, false, true, null]],
        161 => [[['_route' => 'update_Book', '_controller' => 'App\\Controller\\LibraryController::updateBook'], ['id'], ['POST' => 0], null, false, true, null]],
        200 => [[['_route' => 'api_library_book_by_isbn', '_controller' => 'App\\Controller\\LibraryController::getBookByISBN'], ['isbn'], ['GET' => 0], null, false, true, null]],
        226 => [[['_route' => 'draw_number', '_controller' => 'App\\Controller\\LuckyControllerJson::drawCards'], ['number'], ['POST' => 0, 'GET' => 1], null, false, true, null]],
        260 => [[['_route' => 'product_by_id', '_controller' => 'App\\Controller\\ProductController::showProductById'], ['id'], null, null, false, true, null]],
        283 => [[['_route' => 'product_delete_by_id', '_controller' => 'App\\Controller\\ProductController::deleteProductById'], ['id'], null, null, false, true, null]],
        315 => [
