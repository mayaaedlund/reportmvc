...
class __TwigTemplate_bdd5d18e119278376a2aa7f6e71b2127 extends Template
{
    private $source;
    private $macros = [];
...
<ul>
    <li>";
        // line 12
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["diceString"]) || array_key_exists("diceString", $context) ? $context["diceString"] : (function () { throw new RuntimeError('Variable "diceString" does not exist.', 12, $this->source); })()), "html", null, true);
        yield "</li>
</ul>
";
...
{% endblock %}
", "pig/test/roll.html.twig", "/home/maya/dbwebb-kurser/mvc/me/report/templates/pig/test/roll.html.twig");
    }
}
