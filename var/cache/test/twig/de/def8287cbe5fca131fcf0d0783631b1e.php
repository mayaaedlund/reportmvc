...
/* card/play.html.twig */
class __TwigTemplate_f7bcd64997bfc427c7fc002ad0919a89 extends Template
{
    private $source;
    private $macros = [];
...
<p>There are ";
        // line 25
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["cardsLeft"]) || array_key_exists("cardsLeft", $context) ? $context["cardsLeft"] : (function () { throw new RuntimeError('Variable "cardsLeft" does not exist.', 25, $this->source); })()), "html", null, true);
...
{% endblock %}
", "card/play.html.twig", "/home/maya/dbwebb-kurser/mvc/me/report/templates/card/play.html.twig");
    }
}
