...
/* card/api.html.twig */
class __TwigTemplate_05c8e3b438565b522d9326e3f4e7d4a0 extends Template
{
    private $source;
    private $macros = [];
...
<a href=\"";
        ...
        yield "\" class=\"btn btn-primary\">BlackJack</a>
...
";
    ...
    {
        return array (  113 => 18,  108 => 16,  102 => 13,  96 => 10,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
<a href=\"{{ path('api_deck') }}\" class=\"btn btn-primary\">View Deck</a>

<!-- Knapp för att länka till card/deck/shuffle -->
<a href=\"{{ path('api_shuffle') }}\" class=\"btn btn-primary\">Shuffle Deck</a>

<!-- Knapp för att länka till card/draw -->
<a href=\"{{ path('api_draw') }}\" class=\"btn btn-primary\">Draw random Card</a>

<a href=\"{{ path('api_game') }}\" class=\"btn btn-primary\">BlackJack</a>


{% endblock %}
", "card/api.html.twig", "/home/maya/dbwebb-kurser/mvc/me/report2/templates/card/api.html.twig");
    }
}
