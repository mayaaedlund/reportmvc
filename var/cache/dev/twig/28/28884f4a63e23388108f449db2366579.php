...
class __TwigTemplate_7b584e501767251e14209e9438510b70 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"gameplan\">
    ...
    <div class=\"card-container\">
        ...
        if ((array_key_exists("dealerCards", $context) && (isset($context["dealerCards"]) || array_key_exists("dealerCards", $context) ? $context["dealerCards"] : (function () { throw new RuntimeError('Variable "dealerCards" does not exist.', 15, $this->source); })()))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["cardSymbol"]) {
                ...
                yield Twig\Extension\EscaperExtension::escape($this->env, $context["cardSymbol"], "html", null, true);
                yield "</span>
            ";
            }
    ...
    <p class=\"center\">POÄNG: ";
        // line 25
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["dealerpoints"]) || array_key_exists("dealerpoints", $context) ? $context["dealerpoints"] : (function () { throw new RuntimeError('Variable "dealerpoints" does not exist.', 25, $this->source); })()), "html", null, true);
        yield "</p>
    ...
    <p class=\"center\">POÄNG: ";
        // line 47
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["points"]) || array_key_exists("points", $context) ? $context["points"] : (function () { throw new RuntimeError('Variable "points" does not exist.', 47, $this->source); })()), "html", null, true);
        yield "</p>
...
{% endblock %}
", "card/gameplan.html.twig", "/home/maya/dbwebb-kurser/mvc/me/report2/templates/card/gameplan.html.twig");
    }
}
