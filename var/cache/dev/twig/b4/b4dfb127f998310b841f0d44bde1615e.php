...
class __TwigTemplate_873ddcd7b96a0497c65cfaac0363601b extends Template
{
    private $source;
    private $macros = [];
...
<p>You rolled ";
        // line 8
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["num_dices"]) || array_key_exists("num_dices", $context) ? $context["num_dices"] : (function () { throw new RuntimeError('Variable "num_dices" does not exist.', 8, $this->source); })()), "html", null, true);
...
{% endblock %}", "pig/test/dicehand.html.twig", "/home/maya/dbwebb-kurser/mvc/me/report2/templates/pig/test/dicehand.html.twig");
    }
}
