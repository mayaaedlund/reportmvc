...
/* pig/play.html.twig */
class __TwigTemplate_d75815580767e649870ef63c896097bc extends Template
{
    private $source;
    private $macros = [];
...
<p>Round: ";
        // line 20
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["pigRound"]) || array_key_exists("pigRound", $context) ? $context["pigRound"] : (function () { throw new RuntimeError('Variable "pigRound" does not exist.', 20, $this->source); })()), "html", null, true);
        yield "</p>
<p>Total: ";
        // line 21
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["pigTotal"]) || array_key_exists("pigTotal", $context) ? $context["pigTotal"] : (function () { throw new RuntimeError('Variable "pigTotal" does not exist.', 21, $this->source); })()), "html", null, true);
        yield "</p>
...
{% endblock %}
", "pig/play.html.twig", "/home/maya/dbwebb-kurser/mvc/me/report2/templates/pig/play.html.twig");
    }
}
