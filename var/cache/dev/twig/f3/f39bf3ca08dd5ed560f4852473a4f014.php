...
class __TwigTemplate_1c4e193b52b65a7289846671e623b840 extends Template
{
    private $source;
    private $macros = [];
...
<p>There are ";
        // line 21
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["cardsLeft"]) || array_key_exists("cardsLeft", $context) ? $context["cardsLeft"] : (function () { throw new RuntimeError('Variable "cardsLeft" does not exist.', 21, $this->source); })()), "html", null, true);
...
{% endblock %}
", "card/multiple.html.twig", "/home/maya/dbwebb-kurser/mvc/me/report2/templates/card/multiple.html.twig");
    }
}
